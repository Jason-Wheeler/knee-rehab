...
export default function KneeRehabApp() {
  ...
  useEffect(() => {
    const data = { currentPhase, workoutLog, completedMilestones }
    localStorage.setItem('kneeRehabData', JSON.stringify(data))
    ...
    <div style={{ padding: '20px', paddingBottom: '100px' }}>
      ...
      {deferredPrompt && !isInstalled && (
        ...
        >
          ...
          <span style={{ color: '#92400e', fontWeight: '600' }}>Install</span>
        </div>
      )}
      ...
      <div style={{
        ...
        <h2 style={{ fontSize: '28px', fontWeight: '700', marginBottom: '2px' }}>
          {phase.name}
        </h2>
        <p style={{ fontSize: '13px', opacity: 0.85 }}>Weeks {phase.weeks} • {phase.frequency}</p>
  ...
  const WorkoutView = () => (
    <div style={{ padding: '20px', paddingBottom: '100px' }}>
            ...
            >
              ...
              <div style={{ flex: 1 }}>
                ...
                <p style={{ fontSize: '12px', color: '#9ca3af', marginTop: '2px' }}>
                  {exercise.sets && `${exercise.sets}×`}{exercise.reps || exercise.hold || exercise.duration}
      ...
      <div style={{
        ...
        <h3 style={{ fontSize: '13px', fontWeight: '600', color: '#0f766e', marginBottom: '12px' }}>
          Recovery
        </h3>
        <div style={{ display: 'flex', gap: '10px' }}>
          <button
            ...
            style={{
              ...
              fontSize: '13px',
              fontWeight: '500',
              color: todayLog.iced ? 'white' : '#0f766e',
              cursor: 'pointer'
            }}
          >
            🧊 Iced
          ...
          <button
            ...
            style={{
              ...
              fontSize: '13px',
              fontWeight: '500',
              color: todayLog.elevated ? 'white' : '#0f766e',
              cursor: 'pointer'
            }}
          >
            🦵 Elevated
      ...
      {phases.map((p) => {
        ...
        return (
          ...
          >
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '6px' }}>
              ...
              <div>
                <h3 style={{
                  fontSize: '15px',
                  fontWeight: '600',
                  color: isCurrentPhase ? 'white' : '#374151'
                }}>
                  {p.name}
                </h3>
                <p style={{
                  fontSize: '11px',
                  color: isCurrentPhase ? 'rgba(255,255,255,0.8)' : '#9ca3af'
                }}>
                  Weeks {p.weeks}
                </p>
              </div>
            ...
            <p style={{
              fontSize: '12px',
              color: isCurrentPhase ? 'rgba(255,255,255,0.9)' : '#6b7280'
            }}>
              {p.focus}
            </p>
          </div>
    ...
    <div style={{ padding: '20px', paddingBottom: '100px' }}>
      ...
      <div style={{
        ...
        <p style={{ fontSize: '12px', color: '#991b1b', lineHeight: 1.5 }}>
          Sharp pain • Knee giving out • Significant swelling • Locking sensation
        </p>
      </div>
      <NavBar />
    </div>
